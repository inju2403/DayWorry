...
class SelectProfilePhotoBottomSheetFragment(profile_photo: ImageView) : BottomSheetDialogFragment(), CoroutineScope {
    ...
    private fun setUpClickListener(editor: SharedPreferences.Editor) {
        defaultImage1.setOnClickListener {
            ...
            select = 1
            editor.putString("profileImage", "https://hago-bucket.s3.ap-northeast-2.amazonaws.com/default01.png")
            editor.commit()
        }
        defaultImage2.setOnClickListener {
            ...
            select = 2
            editor.putString("profileImage", "https://hago-bucket.s3.ap-northeast-2.amazonaws.com/default04.png")
            editor.commit()
        }
        defaultImage3.setOnClickListener {
            ...
            select = 3
            editor.putString("profileImage", "https://hago-bucket.s3.ap-northeast-2.amazonaws.com/default03.png")
            editor.commit()
        }
        defaultImage4.setOnClickListener {
            ...
            select = 4
            editor.putString("profileImage", "https://hago-bucket.s3.ap-northeast-2.amazonaws.com/default02.png")
            editor.commit()
        }
